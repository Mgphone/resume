...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section
        id="welcome-section"
        className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white flex flex-col justify-center items-center text-center relative"
      >
        <div className="max-w-4xl px-8">
          ...
          <div className="hidden sm:flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              ...
              variant="outline"
              size="lg"
              className="bg-white/20 border-white text-white hover:bg-white hover:text-slate-900"
            >
              <a
            ...
            {[
              ...
              <Button
                ...
                className={`text-white hover:bg-white/20 hover:text-white transition-all duration-200 ${
                  activeSection === nav.id ? "bg-white/30 text-white" : ""
                }`}
              >
      ...
      {/* About Section */}
      <section id="about" className="py-16 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-50 via-white to-purple-50">
            ...
            <div className="space-y-6 lg:space-y-8">
              <div className="prose prose-lg max-w-none">
                <p className="text-lg sm:text-xl text-gray-700 leading-relaxed mb-6">
                  Hi there! I'm a <span className="font-semibold text-purple-700">self-taught programmer</span> and a proud graduate of 
                ...
                <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100 mb-6">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Full Stack Developer at <span className="font-semibold text-blue-600">Mahar Bawga Finance</span>, 
                    where I create dynamic web experiences using JavaScript, TypeScript, React, MongoDB, 
                    and Git, with additional expertise in Node.js, Docker, and Tailwind CSS.
                  </p>
                </div>
                ...
                <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100 mb-6">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    <a
                      href="https://www.moverproremovals.co.uk"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="font-semibold text-purple-600 hover:text-purple-800 underline decoration-2 underline-offset-2 transition-colors"
                    >
                      www.moverproremovals.co.uk
                    </a>
                    , where I handle all the SEO optimization and write all the content myself.
                  </p>
                </div>
                
                <div className="text-center lg:text-left mt-8">
                  <p className="text-lg text-gray-700 font-medium">
                    Let's bring your ideas to life and build exceptional web solutions together!
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                  {['JavaScript', 'TypeScript', 'React', 'Node.js', 'MongoDB', 'Docker'].map((tech) => (
                    <div key={tech} className="bg-gradient-to-r from-purple-100 to-blue-100 rounded-lg p-3 text-center">
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
                <h3 className="text-xl font-bold text-gray-900 mb-4">Additional Skills</h3>
                  ...
                  <CardHeader>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 mt-3">
                      {project.language.map((lang, index) => (
                        <div
                          key={index}
                          className={`px-2 py-1 rounded-md text-xs font-medium text-center ${getLanguageColor(
                            lang
                          )}`}
                        >
                          {lang}
                  ...
                  <CardFooter className="flex flex-col gap-3">
                    ...
                    <Dialog>
                      <DialogTrigger asChild>
                        <Button variant="ghost" size="sm" className="w-full hover:bg-purple-50 hover:text-purple-700 transition-colors">
                          View Details
                        </Button>
                      </DialogTrigger>
                      <DialogContent className="max-w-3xl max-h-[85vh] overflow-y-auto bg-gradient-to-br from-gray-50 to-purple-50 border-0 shadow-2xl">
                        <DialogHeader className="pb-6 border-b border-gray-200">
                          <DialogTitle className="text-2xl font-bold text-gray-900 mb-2">{project.title}</DialogTitle>
                          <div className="flex flex-wrap gap-2">
                            {(expandedProjects.has(project.id) 
                              ? project.language 
                              : project.language.slice(0, 7)
                            ).map((lang, index) => (
                              <div key={index} className={`px-3 py-1 rounded-full text-xs font-medium ${getLanguageColor(lang)}`}>
                                {lang}
                              </div>
                            ))}
                            {project.language.length > 7 && (
                              <button
                                onClick={() => toggleProjectExpansion(project.id)}
                                className="px-3 py-1 rounded-full text-xs font-medium bg-gray-500 text-white hover:bg-gray-600 transition-colors cursor-pointer"
                              >
                                {expandedProjects.has(project.id) 
                                  ? 'Show less' 
                                  : `+${project.language.length - 7} more`
                                }
                              </button>
                            )}
                          </div>
                        ...
                        <div className="space-y-6 pt-6">
                          ...
                          <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100 mt-6">
                            <h4 className="font-bold text-xl text-gray-900 mb-4">Project Links</h4>
      ...
      <div className="sm:hidden fixed bottom-6 left-6 z-50">
        <Button
          asChild
          size="lg"
          className="bg-purple-600 text-white hover:bg-purple-700 shadow-lg rounded-full"
        >
          <a
            href="https://drive.google.com/file/d/1QX5CYh1e4nAbWEJYUTTNDM6HILXhEDUu/view?usp=sharing"
            target="_blank"
